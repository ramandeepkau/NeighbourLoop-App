...
const CombinedPage: React.FC = () => {
  ...
  <div className="absolute top-10 left-10 w-96 max-w-sm bg-white bg-opacity-90 p-6 rounded-lg shadow-lg z-20">
    {/* Combined Heading and Stops */}
    <div className="text-center">
      <h1 className="text-3xl font-bold text-gray-800 mb-6">Bus Timetable</h1>
      <h2 className="text-2xl font-semibold mb-4">Stops for {selectedService.code}</h2>
    </div>
