...
const Home: React.FC = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-gradient-to-r from-blue-100 to-blue-200 p-6">
      <h1 className="text-4xl font-bold text-blue-600 mb-8 text-center">Bus Timetable v2</h1>
            ...
            <DropdownMenuContent align="end">
              {Object.keys(columnVisibility).map((column) => (
                <DropdownMenuCheckboxItem
                  ...
                  checked={columnVisibility[column as ColumnKey]}
                  onCheckedChange={() => toggleColumnVisibility(column as ColumnKey)}
                >
                  {column}
                </DropdownMenuCheckboxItem>
              ))}
