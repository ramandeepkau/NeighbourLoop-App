...
import styles from './Timetable.module.css'; // Import CSS Module
...
export const columns: ColumnDef<BusSchedule>[] = [
  ...
  },
  {
    ...
    header: "Status",
    cell: ({ row }) => {
      const status = row.getValue("status") as BusSchedule["status"];
      return (
...
const Home: React.FC = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-gray-100 p-4">
      <h1 className={`text-4xl font-bold text-blue-500 mb-8 ${styles.header}`}>Bus Timetable v1</h1>
